...
* repository: aka repo - a record of all changes to specified files <img src="images/repo.svg" width="128">
* commit: one change record <img src="images/commit.png" width="128">
